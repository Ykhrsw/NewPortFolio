          ...
          {timelineData.map((item, idx) => (
            <div
              ...
              style={{
                ...
                transition: 'all 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards',
      ...
      <div className="skills-hobbies">
        <div>
          ...
          <div className="skills-list">
            {(t('about_skills') || 'HTML / CSS / JavaScript / React').split(' / ').map((skill, i) => (
        ...
        <div>
          ...
          <div className="hobbies-list">
            {(t('about_hobbies') || '旅行 / 読書 / 運動').split(' / ').map((hobby, i) => (
